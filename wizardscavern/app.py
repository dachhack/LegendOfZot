...
def generate_ambient_audio_js(mood, enabled):
    ...
    (function() {{
        ...
        try {{
            ...
            // 64 steps (8 bars): A section (0-31) + B section (32-63)
            var songs = {{
                explore: {{
                    bpm: 110,
                ...
                shop: {{
                    bpm: 100,
                    pulse1: [[0,349,2],[2,440,1],[3,523,2],[6,440,1],[7,349,1],[8,330,2],[10,294,1],[11,262,1],[12,294,2],[14,349,2],[16,440,2],[18,523,1],[19,587,2],[22,523,1],[23,440,1],[24,349,3],[28,262,2],[30,349,2], [32,523,2],[34,440,1],[35,349,1],[36,294,2],[38,349,1],[39,440,1],[40,523,2],[42,587,1],[43,659,2],[46,587,1],[47,523,1],[48,440,2],[50,349,1],[51,294,1],[52,349,3],[56,440,2],[58,523,1],[59,440,1],[60,349,4]],
                    pulse2: [[0,262,2],[4,349,2],[8,262,2],[12,220,2],[16,262,2],[20,349,2],[24,262,2],[28,220,2], [32,349,2],[36,262,2],[40,349,2],[44,440,2],[48,349,2],[52,262,2],[56,349,2],[60,262,2]],
                    triangle: [[0,175,2],[2,196,2],[4,220,2],[6,175,2],[8,165,2],[10,175,2],[12,147,2],[14,131,2],[16,175,2],[18,196,2],[20,220,2],[22,175,2],[24,165,2],[26,175,2],[28,147,2],[30,175,2], [32,175,2],[34,220,2],[36,196,2],[38,175,2],[40,165,2],[42,175,2],[44,196,2],[46,220,2],[48,175,2],[50,196,2],[52,220,2],[54,175,2],[56,165,2],[58,175,2],[60,147,2],[62,175,2]],
                ...
                mystery: {{
                    bpm: 80,
                    pulse1: [[0,311,3],[6,392,2],[12,494,3],[20,440,2],[26,349,3], [34,440,3],[40,311,2],[46,494,2],[52,392,3],[58,349,2]],
                    pulse2: [[4,554,4],[16,494,4], [36,349,4],[48,554,4]],
                    triangle: [[0,78,8],[8,87,8],[16,78,8],[24,98,8], [32,87,8],[40,78,8],[48,98,8],[56,78,8]],
                    noise: [[0,6000,1],[8,6000,1],[16,6000,1],[24,6000,1], [32,6000,1],[40,6000,1],[48,6000,1],[56,6000,1]]
                }},
                deep: {{
                    bpm: 85,
                    pulse1: [[0,165,3],[6,175,2],[10,196,3],[16,220,2],[20,196,2],[24,175,3],[28,165,4], [32,196,3],[38,220,2],[42,247,3],[48,220,2],[52,196,2],[56,175,3],[60,165,4]],
                    pulse2: [[0,131,4],[8,110,4],[16,131,4],[24,98,8], [32,110,4],[40,131,4],[48,110,4],[56,98,8]],
                    triangle: [[0,82,4],[4,87,4],[8,82,4],[12,65,4],[16,82,4],[20,87,4],[24,82,4],[28,65,4], [32,87,4],[36,82,4],[40,65,4],[44,87,4],[48,82,4],[52,87,4],[56,82,4],[60,65,4]],
                    noise: [[0,150,2],[8,150,2],[16,150,2],[24,150,2], [32,150,2],[40,150,2],[48,150,2],[56,150,2]]
                }},
                garden: {{
                    bpm: 105,
                    pulse1: [[0,392,2],[2,330,1],[3,294,1],[4,330,2],[6,392,2],[8,440,2],[10,392,1],[11,330,1],[12,294,3],[16,262,2],[18,294,1],[19,330,1],[20,392,2],[22,440,2],[24,523,3],[28,440,1],[29,392,1],[30,330,2], [32,294,2],[34,330,1],[35,392,1],[36,440,2],[38,523,2],[40,440,1],[41,392,1],[42,330,2],[44,294,3],[48,330,2],[50,392,1],[51,440,1],[52,523,2],[54,440,2],[56,392,2],[58,330,1],[59,294,1],[60,330,4]],
                    pulse2: [[0,247,2],[4,262,2],[8,294,2],[12,247,2],[16,262,2],[20,294,2],[24,330,2],[28,262,2], [32,262,2],[36,294,2],[40,262,2],[44,247,2],[48,262,2],[52,294,2],[56,262,2],[60,247,2]],
                    triangle: [[0,98,2],[2,123,2],[4,131,2],[6,98,2],[8,110,2],[10,123,2],[12,131,2],[14,147,2],[16,98,2],[18,123,2],[20,131,2],[22,98,2],[24,110,2],[26,123,2],[28,131,2],[30,98,2], [32,131,2],[34,123,2],[36,98,2],[38,131,2],[40,110,2],[42,123,2],[44,131,2],[46,98,2],[48,131,2],[50,123,2],[52,98,2],[54,131,2],[56,110,2],[58,123,2],[60,131,2],[62,98,2]],
                    noise: [[4,8000,1],[12,8000,1],[20,8000,1],[28,8000,1], [36,8000,1],[44,8000,1],[52,8000,1],[60,8000,1]]
                }},
                death: {{
                    bpm: 70,
...
class WizardsCavernApp(toga.App):
        ...
        if is_altar:
            ...
            if can_offer:
                numpad_rows[2][2] = toga.Button(
                    ...
                    style=Pack(width=55, margin=0, font_size=11, font_weight='bold', color='#FFD700', height=26))
    ...
    def create_numpad_button(self, number, compact=False):
        ...
        fs = 11 if compact else 11
        btn = toga.Button(
            number,
            on_press=lambda w, n=number: self.number_pad_input(n),
            style=Pack(margin=1, font_size=fs, font_weight='bold', width=50,
