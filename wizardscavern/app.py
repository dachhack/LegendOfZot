        ...
        if gs.prompt_cntl == "intro_story" or gs.prompt_cntl == "main_menu":
            ...
            monster_html = f"""
                <div id="monster_panel" style="position:relative; padding: 3px; border-radius: 3px; {evo_border_style} margin-bottom: 4px;">
                    ...
                    <div id="monster_init_dice" style="position:absolute;right:130px;top:50%;transform:translateY(-50%) scale(2.0);transform-origin:right center;width:40px;height:56px;z-index:5;"></div><div id="monster_dice" style="position:absolute;right:4px;top:50%;transform:translateY(-50%);width:68px;height:52px;display:flex;gap:4px;"><div id="monster_def_dice" style="position:relative;width:32px;height:52px;"></div><div id="monster_atk_dice" style="position:relative;width:32px;height:52px;"></div></div>
                </div>
                    </div>
            ...
            player_combat_html = f"""
                <div id="player_panel" style="position:relative; padding: 3px; border-radius: 3px; border: 2px solid #666;{low_hp_pulse_style}">
                    ...
                    <div id="player_init_dice" style="position:absolute;right:130px;top:50%;transform:translateY(-50%) scale(2.0);transform-origin:right center;width:40px;height:56px;z-index:5;"></div><div id="player_dice" style="position:absolute;right:4px;top:50%;transform:translateY(-50%);width:68px;height:52px;display:flex;gap:4px;"><div id="player_atk_dice" style="position:relative;width:32px;height:52px;"></div><div id="player_def_dice" style="position:relative;width:32px;height:52px;"></div></div>
                </div>
                    </div>
