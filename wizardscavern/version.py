...
CHANGELOG = [
    "Inventory icons expanded: Scrolls, Spells, and Rings/Amulets now have sprites too",
    "Potions now show inventory icons — each cryptic appearance gets a unique bottle (Gemini sheet)",
