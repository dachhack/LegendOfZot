...
from .items import (
    Potion, Ingredient, Weapon, Armor, Scroll, Lantern, LanternFuel,
    Food, CookingKit, Sausage, Treasure, Spell, LembasWafer,
)
...
UTILITY_TEMPLATES = [
    Lantern(name="Lantern", description="Provides continuous light with fuel.", fuel_amount=10, light_radius=3, value=30, level=0),
